...
void draw7Seg(int x, int y, int w, int h, int d, int t = 3) {
  ...
  if (s & 0b0010000) fillRect(x + w - t, my, t, h / 2, true);
  if (s & 0b0001000) fillRect(x, y + h - t, w, t, true);
  if (s & 0b0000100) fillRect(x, my, t, h / 2, true);
  if (s & 0b0000010) fillRect(x, y, t, h / 2, true);
  if (s & 0b0000001) fillRect(x, my - t / 2, w, t, true);
}
...
void drawHud() {
  ...
  // Status
  drawLine(10, 172, 190, 172);
  drawText(58, 182, "SYS NOMINAL", 1);
